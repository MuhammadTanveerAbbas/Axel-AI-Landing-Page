...
/**
 * Core data definitions for the Axel AI site.
 * Only exports plain constants—no React components—
 * so Fast Refresh won’t complain.
 */
...
export const features = [
  {
    ...
    title: "Work smarter, not harder & efficient",
    text: "With Axel AI Assistance, tedious tasks are eliminated. Automate workflows and maximize output—no caffeine required.",
    button: {
  ...
  },
  {
    ...
    title: "Sleep easy we’ve got your back",
    text: "Data security is mission-critical. Axel leverages end-to-end encryption protocols to keep your assets protected.",
    button: {
...
export const faq = [
  {
    id: "1",
    question: "Can I integrate Axel AI with other platforms?",
    answer:
      "Yes. Axel supports integrations with major platforms through APIs, webhooks, and third-party connectors like Zapier and Make.",
  },
  {
    id: "2",
    question: "How often do you release new features?",
    answer:
      "We deploy improvements weekly and roll out major feature updates every quarter, based on roadmap priorities and customer feedback.",
  },
  {
    id: "3",
  ...
  },
  {
    ...
    answer:
      "Yes. We offer tailored enterprise plans with SSO, SLA, onboarding assistance, and volume discounts. Contact sales for details.",
  },
  {
    id: "5",
    question: "What happens when I run out of storage?",
    answer:
      "You’ll be notified proactively and can upgrade or archive files. Axel never deletes your data without explicit permission.",
  },
  {
    id: "6",
    question: "Can I upgrade my plan at any time?",
    answer:
      "Absolutely. Plan upgrades are instant and pro-rated to ensure cost efficiency.",
  },
  {
    id: "7",
    question: "How do I invite my team?",
    answer:
      "Go to your dashboard → Team Settings → Invite Members. Each user will get their own secure access credentials.",
  },
  {
    id: "8",
    question: "Do you offer training for teams?",
    answer:
      "Yes. We provide both self-serve tutorials and live training sessions for teams of all sizes.",
  },
  {
    id: "9",
    question: "I’m locked out of my account what now?",
    answer:
      "Click “Forgot Password” on the login screen. If you’re still locked out, contact support via chat or email.",
  },
];
...
export const plans = [
  ...
  },
  {
    id: "2",
    title: "Team",
    caption: "Optimized for teams",
    priceMonthly: 39,
    priceYearly: 29,
    features: [
      "All Overdrive features",
      "10 TB additional storage",
      "Team billing (50% off per member)",
...
export const testimonials = [
  {
    ...
    comment:
      "Axel's customer support is second to none. They’re like tech superheroes—always on point and responsive.",
  },
  {
    id: "1",
    name: "Mark Erixon",
    ...
    comment:
      "I was skeptical at first, but now I can't imagine our operations without it. It’s a game changer.",
  },
  {
    id: "2",
    name: "Melanie Hurst",
    ...
    comment:
      "Adopting Axel was frictionless. It simplifies our entire content pipeline.",
  },
];
